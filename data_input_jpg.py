...
def input_batches(batch_size, output_size, input_files, input_labels, input_ids, out_height, out_width, out_channel, nl_jpg=None,
                  regression=False, augmentation=True, normalization=True, repeat=True):
    '''
     Args:
        ...
        input_class: np.array shaped (:,), all input image labels
        nl_jpg: np.array shaped (:,), all input night light image, with 5x5x1 size
